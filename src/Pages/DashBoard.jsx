...
const DashBoard = () => {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      setLoading(true);
      try {
        const response = await fetch(`${import.meta.env.VITE_SERVER_BASE_URL}/api/courses`, {
          headers: {
  ...
  const handleJoin = async (courseId) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_SERVER_BASE_URL}/api/courses/join/${courseId}`, {
        method: 'POST',
        headers: {
  ...
  const handleDelete = async (courseId) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_SERVER_BASE_URL}/api/courses/${courseId}`, {
        method: 'DELETE',
        headers: {
          Authorization: `Bearer ${token}`,
        },
